...
function markNotificationAsReadAdmin(id) {
  $.ajax({
    url: `/notifications-update-admin/${id}`, // Assuming this URL updates the notification status
    dataType: 'json',
    method: 'get',
    success: function (data) {

      window.location.href = `/admin/forum/post#postNotif${data.id}`;
