...
function showQuetions(index) {
    ...
    let que_tag = '<span>' + "Q" + ": " + questions[index].question + '</span>';
...
let tickIconTag = '<div class="icon tick"><i class="bx bx-trophy"></i></div>';
...
function showResult() {
    ...
    if (userScore > 3) { // if user scored more than 3
        ...
        let scoreTag = '<span>You got <p>' + userScore + '</p> out of <p>' + questions.length + '</p> your score will converted as XP points <p>' + '</p></span>';
        scoreText.innerHTML = scoreTag;  //adding new span tag inside score_Text
    }
    else if (userScore > 1) { // if user scored more than 1
        let scoreTag = '<span>and nice , You got <p>' + userScore + '</p> out of <p>' + questions.length + '</p> your score will converted as XP points <p>' + '</p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else { // if user scored less than 1
        let scoreTag = '<span>and sorry , You got only <p>' + userScore + '</p> out of <p>' + questions.length + '</p> your score will converted as XP points <p>' + '</p></span>';
        scoreText.innerHTML = scoreTag;
    }
