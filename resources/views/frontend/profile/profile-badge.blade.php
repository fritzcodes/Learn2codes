...
<body>
  ...
  <section class="team">
    ...
    <div class="head">
      <ul>
        <li><a href="#" onclick="showDiv('div1', this);" class="active"><i class='bx bx-border-all'></i>
            <p>List</p>
          </a></li>
        <li><a href="{{ route('badge.search') }}" onclick="showDiv('div2', this);" type="button" class="btn-primary"><i class='bx bxs-collection'></i>
    ...
    <div id="div1" class="team-content">
      ...
      <div class="badge {{ $percentage >= 100 ? '' : 'locked' }}">
        ...
        <a href="/e-cert/{{$claimedBadge->language}}"><button class="btns">View Certificate</button></a>
        <?php $met = false;
        break; ?>
        @endif
