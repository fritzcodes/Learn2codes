...
<body>
    ...
    <div class="info_box">
        ...
        <div class="buttons">
            <button class="leave"><a href="{{ route('c#Easy') }}">Exit Quiz</a></button>
    ...
    <script src="assets/js/csharp/csharpQueeasy15.js"></script>

    <!-- Inside this JavaScript file I've coded all Quiz Codes -->
    <script src="assets/js/csharp/quizContenteasy.js"></script>
