...
<body>
    ...
    <div class="info_box">
        ...
        <div class="buttons">
            <button class="leave"><a href="{{ route('c#Medium') }}">Exit Quiz</a></button>
    ...
    <script src="assets/js/csharp/csharpQuemed10.js"></script>

    <!-- Inside this JavaScript file I've coded all Quiz Codes -->
    <script src="assets/js/csharp/quizContentmed.js"></script>
