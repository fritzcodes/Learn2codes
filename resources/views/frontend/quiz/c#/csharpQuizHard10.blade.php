...
<body>
    ...
    <div class="info_box">
        ...
        <div class="buttons">
            <button class="leave"><a href="{{ route('c#Hard') }}">Exit Quiz</a></button>
    ...
    <script src="assets/js/csharp/csharpQuehard10.js"></script>

    <!-- Inside this JavaScript file I've coded all Quiz Codes -->
    <script src="assets/js/csharp/quizContenthard.js"></script>
