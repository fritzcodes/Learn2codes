...
<body>
    ...
    <div class="info_box">
        ...
        <div class="buttons">
            <button class="leave"><a href="{{ route('javaHard') }}">Exit Quiz</a></button>
    ...
    <script src="assets/js/Java/javaQuehard10.js"></script>

    <!-- Inside this JavaScript file I've coded all Quiz Codes -->
    <script src="assets/js/Java/quizContenthard.js"></script>
