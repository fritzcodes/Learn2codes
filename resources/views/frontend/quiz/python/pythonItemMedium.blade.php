...
<body>
  ...
  <header>
    <a href="{{ route('pythonDiff') }}" class="bx bx-chevron-left" id="back-btn"></a>
  ...
  <section class="space-background">
     ...
     <div class="content-section">
        <a>
        <img src="assets/images/python_diff.svg" alt="Java" id="logo">
        </a>

        <div class="content-container1">

          <a href="{{ route('PythonMedium10') }}" id="items"><h1>10 Items</h1>
          </a>

          <a href="{{ route('PythonMedium15') }}" id="items"><h1>15 Items</h1>
          </a>

          <a href="{{ route('PythonMedium20') }}" id="items"><h1>20 Items</h1>
          </a>

          <a href="{{ route('PythonMedium30') }}" id="items"><h1>30 Items</h1>
          </a>
