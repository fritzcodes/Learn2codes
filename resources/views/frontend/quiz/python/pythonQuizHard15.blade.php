...
<body>
    ...
    <div class="info_box">
        ...
        <div class="buttons">
            <button class="leave"><a href="{{ route('pythonHard') }}">Exit Quiz</a></button>
    ...
    <div class="quiz_box">
        <header>
            <div class="title">Python: Hard </div>
            <div class="timer">
    ...
    <script src="assets/js/python/pythonQuehard15.js"></script>

    <!-- Inside this JavaScript file I've coded all Quiz Codes -->
    <script src="assets/js/python/quizContenthard.js"></script>
