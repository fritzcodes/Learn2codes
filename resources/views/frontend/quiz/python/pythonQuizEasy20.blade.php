...
<body>
    ...
    <div class="info_box">
        ...
        <div class="buttons">
            <button class="leave"><a href="{{ route('pythonEasy') }}">Exit Quiz</a></button>
    ...
    <div class="quiz_box">
        <header>
            <div class="title">Python: Easy </div>
            <div class="timer">
    ...
    <script src="assets/js/python/pythonQueeasy20.js"></script>

    <!-- Inside this JavaScript file I've coded all Quiz Codes -->
    <script src="assets/js/python/quizContenteasy.js"></script>
