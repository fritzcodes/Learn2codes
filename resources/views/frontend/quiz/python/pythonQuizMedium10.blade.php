...
<body>
    ...
    <div class="info_box">
        ...
        <div class="buttons">
            <button class="leave"><a href="{{ route('pythonMedium') }}">Exit Quiz</a></button>
    ...
    <div class="quiz_box">
        <header>
            <div class="title">Python: Medium </div>
            <div class="timer">
    ...
    <script src="assets/js/python/pythonQuemed10.js"></script>

    <!-- Inside this JavaScript file I've coded all Quiz Codes -->
    <script src="assets/js/python/quizContentmed.js"></script>
