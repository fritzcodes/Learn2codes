  ...
  <section class="space-background">
     ...
     <div class="content-section">
        ...
        <div class="content-container1">
          ...
          <a href="{{ route('PythonEasy10') }}" id="items"><h1>10 Items</h1>
          </a>

          <a href="{{ route('PythonEasy15') }}" id="items"><h1>15 Items</h1>
          </a>

          <a href="{{ route('PythonEasy20') }}" id="items"><h1>20 Items</h1>
          </a>

          <a href="{{ route('PythonEasy30') }}" id="items"><h1>30 Items</h1>
          </a>
