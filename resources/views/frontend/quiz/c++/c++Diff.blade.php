...
<body>
  ...
  <section class="space-background">
     ...
     <div class="content-section">
        <a>
        <img src="assets/images/cpp_diff.svg" alt="Quizzes" id="logo">
        </a>

        <div class="content-container1">

          <a href="{{ route('c++Easy') }}" id="easy"><h1>Easy</h1>
          </a>

          <a href="{{ route('c++Medium') }}" id="medium"><h1>Medium</h1>
          </a>

          <a href="{{ route('c++Hard') }}" id="hard"><h1>Hard</h1>
          </a>
